...
static CSC_STATUS CSCMETHOD CSC_DynamicArrayIContainerInitialize(_Out_ CONST CSC_PVOID pMemoryBaseAddress, _In_ CONST CSC_SIZE_T elementSize, _In_ CONST CSC_IAllocator* CONST pIAllocator);
