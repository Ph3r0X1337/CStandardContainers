...
typedef CSC_STATUS(CSCMETHOD* CSC_P_I_ITERATOR_ON_INSERTION)(_Inout_ struct _CSC_IIterator* CONST pThis, CONST CSC_SIZE_T insertIndex, CONST CSC_SIZE_T numOfElements, CONST CSC_SIZE_T newSize);
typedef CSC_STATUS(CSCMETHOD* CSC_P_I_ITERATOR_ON_REMOVAL)(_Inout_ struct _CSC_IIterator* CONST pThis, CONST CSC_SIZE_T removeIndex, CONST CSC_SIZE_T numOfElements, CONST CSC_SIZE_T newSize);
